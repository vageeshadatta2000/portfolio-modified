                ...
                <div className="max-w-5xl mx-auto px-6 lg:px-8">
                    <motion.div className="text-center mb-16">
                        ...
                        <motion.p
                            ...
                            className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto"
                        >
                            Writing about LLMs, AI research, and things I find fascinating
                        </motion.p>
                    </motion.div>
                    ...
                    <div className="space-y-8">
                        {BLOG_POSTS.map((post, index) => (
                            <motion.article
                                ...
                                viewport={{ once: true }}
                                transition={{ duration: 0.5, delay: index * 0.1 }}
                                className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden hover:border-slate-300 dark:hover:border-slate-600 transition-all duration-300"
                            >
                                <div className="p-8">
                                    ...
                                    >
                                        ...
                                        <motion.svg
                                            animate={{ rotate: expandedPost === post.title ? 180 : 0 }}
                                            className="w-5 h-5"
                                            viewBox="0 0 24 24"
                                            fill="none"
                                            stroke="currentColor"
                                                            ...
                                                            <div className="flex flex-wrap gap-3">
                                                                {post.links.map((link, linkIndex) => (
                                                                    <a
                                                                        ...
                                                                        target="_blank"
                                                                        rel="noopener noreferrer"
                                                                        className="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-900/30 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors text-sm font-medium"
                                                                    >
                                                                        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
                                                                            <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                                                                        </svg>
